<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SalesDay.aspx.cs" Inherits="SalonCRM.Stat.SalesDay" %>
        ...
        <form id="form1" runat="server">
            <table class="OptionsTable BottomMargin">
                <tr style="height: 45px;">
                    ...
                    <td style="padding-right: 4px">
                        <dx:ASPxComboBox ID="cbBrand" runat="server" ValueType="System.String">
                        </dx:ASPxComboBox>
                    </td>
            ...
            <br />
            <dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False" Width="100%" OnCustomCallback="grid_CustomCallback" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="项目" VisibleIndex="2" FieldName="ProjectName" Width="200">
                    </dx:GridViewDataTextColumn>
