<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CardSalesDay.aspx.cs" Inherits="SalonCRM.Stat.CardSalesDay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function OnCountryChanged(cbCardType) {
            if (cbCardTmpl.InCallback())
                lastCountry = cbCardType.GetValue().toString();
            else
                cbCardTmpl.PerformCallback(cbCardType.GetValue().toString());
        }
        function OnEndCallback(s, e) {
            if (lastCountry) {
                cbCardTmpl.PerformCallback(lastCountry);
                lastCountry = null;
            }
        }
    </script>
        ...
        <form id="form1" runat="server">
            <table class="OptionsTable BottomMargin">
                <tr style="height: 45px;">
                    ...
                    <td style="padding-right: 4px">卡项</td>
                    <td style="padding-right: 4px">
                        <dx:ASPxComboBox ID="cbCardType" runat="server" ValueType="System.String">
                            <ClientSideEvents SelectedIndexChanged="function(s, e) { OnCountryChanged(s); }" />
                        </dx:ASPxComboBox>
                    </td>
                    <td style="padding-right: 4px">套餐</td>
                    <td style="padding-right: 4px">
                        <dx:ASPxComboBox ID="cbCardTmpl" runat="server" ClientInstanceName="cbCardTmpl" ValueType="System.String" OnCallback="cbCardTmpl_Callback">
                ...
                <tr>
                    ...
                    <td style="padding-right: 4px">统计对象</td>
                    <td style="padding-right: 4px">
                        <dx:ASPxComboBox ID="cbStat" runat="server">
                            <Items>
                                <dx:ListEditItem Text="金额" Value="1" Selected="true" />
                                <dx:ListEditItem Text="张数" Value="2" />
                            </Items>
                        </dx:ASPxComboBox>
                    </td>
                    <td style="padding-right: 4px">
            ...
            <dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False" Width="100%" OnCustomCallback="grid_CustomCallback" SettingsPager-PageSize="20">
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="卡项类型" VisibleIndex="2" FieldName="CardTitle" Width="200">
                    </dx:GridViewDataTextColumn>
