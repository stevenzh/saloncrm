...
namespace Senparc.Weixin.MP.Sample.Controllers
{
    ...
    public partial class WeixinController : Controller
    {
        ...
        public ActionResult OldPost(string signature, string timestamp, string nonce, string echostr)
        {
            ...
            if (!CheckSignature.Check(signature, timestamp, nonce, bag.Token))
            {
                return Content("参数错误！");
            }
                    ...
                    case RequestMsgType.Text://文字
                        {
                            ...
                            var strongresponseMessage =
                                ResponseMessageBase.CreateFromRequestMessage(requestMessage, ResponseMsgType.Text) as ResponseMessageText;
                    ...
                    case RequestMsgType.Image://图片
                        {
                            ...
                            var strongresponseMessage =
                                ResponseMessageBase.CreateFromRequestMessage(requestMessage, ResponseMsgType.News) as ResponseMessageNews;
                    ...
                    case RequestMsgType.Voice://语音
                        {
                            ...
                            var strongresponseMessage =
                               ResponseMessageBase.CreateFromRequestMessage(requestMessage, ResponseMsgType.Music) as ResponseMessageMusic;
