...
namespace Senparc.Weixin.MP.Sample.CommonService.CustomMessageHandler
{
    ...
    {
        private WxMemberManager service = new WxMemberManager();
        ...
        private string GetWelcomeInfo()
        {
            ...
            return string.Format(@"欢迎关注{0}。", version);
        }

        public string GetDownloadInfo(CodeRecord codeRecord)
        {
            return string.Format(@"您已通过二维码验证，浏览器即将开始{0}", codeRecord.Version);
        }
        ...
        public override IResponseMessageBase OnEvent_SubscribeRequest(RequestMessageEvent_Subscribe requestMessage)
        {
            ...
            service.Subscribe(1, u.openid, u.nickname, u.language, u.sex, u.city, u.province, u.country,
                u.headimgurl, DateTimeHelper.GetDateTimeFromXml(u.subscribe_time));
